...
export default async function NewPostPage() {
  ...
  async function createPost(formData: FormData) {
    ...
    if (productsJson) {
      try {
        ...
        // If products fail, delete the post and show error
  ...
  return (
    <div>
      <h1 className="text-3xl sm:text-4xl font-black uppercase mb-6 md:mb-8 admin-heading">Create New Post</h1>
      <PostForm categories={categories} action={createPost} allPosts={allPosts} />
    </div>
  );
}
